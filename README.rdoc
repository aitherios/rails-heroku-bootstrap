...
* Update favicons and apple-touch-icons located at public/
* Update Amazon S3 variables
* Create Facebook app and update system variables
* Update APP_HOSTNAME with final hostname, not the something.herokuapp.com
* Update GOOGLE_ANALYTICS_ID
